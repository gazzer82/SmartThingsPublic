 ...
 *    2015-09-20  Gareth Jeanne  Updated namespace for correct github allocation
 *

 */
metadata {
	definition (name: "Virtual Contact Sensor", namespace: "gazzer82", author: "Gareth Jeanne") {
